...
DROP TRIGGER TR_update_avg_rating;
    ...
    VALUES (1, 1, 'The Shawshank Redemption', 1994, 'Frank Darabont', NULL, 'Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency.');
    INSERT INTO MM_Movies (movie_id, genre_id, movie_title, release_year,  directorName, average_rating, description)
    VALUES (2, 1, 'The Godfather', 1972, 'Francis Ford Coppola', NULL, 'The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.');
    INSERT INTO MM_Movies (movie_id, genre_id, movie_title, release_year,  directorName, average_rating, description)
    VALUES (3, 3, 'The Dark Knight', 2008, 'Christopher Nolan', NULL, 'When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, Batman must accept one of the greatest psychological and physical tests of his ability to fight injustice.');
    INSERT INTO MM_Movies (movie_id, genre_id, movie_title, release_year,  directorName, average_rating, description)
    VALUES (4, 4, 'Pulp Fiction', 1994, 'Quentin Tarantino', NULL, 'The lives of two mob hitmen, a boxer, a gangster and his wife, and a pair of diner bandits intertwine in four tales of violence and redemption.');
    INSERT INTO MM_Movies (movie_id, genre_id, movie_title, release_year,  directorName, average_rating, description)
    VALUES (5, 2, 'The Lord of the Rings: The Fellowship of the Ring', 2001, 'Peter Jackson', NULL, 'A young hobbit, Frodo, who has found the One Ring that belongs to the Dark Lord Sauron, begins his journey with eight companions to Mount Doom, the only place where it can be destroyed.');
    INSERT INTO MM_Movies (movie_id, genre_id, movie_title, release_year,  directorName, average_rating, description)
    VALUES (6, 1, 'Schindler''s List', 1993, 'Steven Speilberg', NULL, 'In Poland during World War II, Oskar Schindler gradually becomes concerned for his Jewish workforce after witnessing their persecution by the Nazis.');
    INSERT INTO MM_Movies (movie_id, genre_id, movie_title, release_year,  directorName, average_rating, description)
    VALUES (7, 4, 'Goodfellas', 1990, 'Martin Scorsese', NULL, 'The story of Henry Hill and his life in the mob, covering his relationship with his wife Karen Hill and his mob partners Jimmy Conway and Tommy DeVito in the Italian-American crime syndicate.');
    INSERT INTO MM_Movies (movie_id, genre_id, movie_title, release_year,  directorName, average_rating, description)
    VALUES (8, 1, 'Titanic', 1997, 'James Cameron', NULL, 'A seventeen-year-old aristocrat falls in love with a kind but poor artist aboard the luxurious, ill-fated R.M.S. Titanic.');
    INSERT INTO MM_Movies (movie_id, genre_id, movie_title, release_year, directorName, average_rating, description)
    VALUES (9, 1, 'Psycho', 1960, 'Alfred Hitchcock', NULL, 'A Phoenix secretary embezzles $40,000 from her employer''s client, goes on the run, and checks into a remote motel run by a young man under the domination of his mother.');
    INSERT INTO MM_Movies (movie_id, genre_id, movie_title, release_year, directorName, average_rating, description)
    VALUES (10, 1, 'The Shining', 1980, 'Stanley Kubrick', NULL, 'A family heads to an isolated hotel for the winter where a sinister presence influences the father into violence, while his psychic son sees horrific forebodings from both past and future.');
    INSERT INTO MM_Movies (movie_id, genre_id, movie_title, release_year, directorName, average_rating, description)
    VALUES (11, 5, 'Edward Scissorhands', 1990, 'Tim Burton', NULL, 'A gentle man with scissors for hands is brought into a new community after living in isolation.');
    INSERT INTO MM_Movies (movie_id, genre_id, movie_title, release_year, directorName, average_rating, description)
    VALUES (12, 1, 'Fight Club', 1999, 'David Fincher', NULL, 'An insomniac office worker and a devil-may-care soapmaker form an underground fight club that evolves into something much, much more.');
    INSERT INTO MM_Movies (movie_id, genre_id, movie_title, release_year, directorName, average_rating, description)
    VALUES (13, 3, 'Gladiator', 2000, 'Ridley Scott', NULL, 'A former Roman General sets out to exact vengeance against the corrupt emperor who murdered his family and sent him into slavery.');
    INSERT INTO MM_Movies (movie_id, genre_id, movie_title, release_year, directorName, average_rating, description)
    VALUES (14, 1, 'Little Women', 2019, 'Greta Gerwig', NULL, 'Jo March reflects back and forth on her life, telling the beloved story of the March sisters - four young women each determined to live life on her own terms.');
    INSERT INTO MM_Movies (movie_id, genre_id, movie_title, release_year, directorName, average_rating, description)
    VALUES (15, 1, 'Lost in Translation', 2003, 'Sofia Coppola', NULL, 'A faded movie star and a neglected young woman form an unlikely bond after crossing paths in Tokyo.');
    INSERT INTO MM_Movies (movie_id, genre_id, movie_title, release_year, directorName, average_rating, description)
    VALUES (16, 3, 'Children of Men', 2006, 'Alfonso Cuarón', NULL, 'In a chaotic world in which humans can no longer procreate, a former activist agrees to help transport a miraculously pregnant woman to a sanctuary at sea, where her child''s birth may help scientists save the future of humankind.');
